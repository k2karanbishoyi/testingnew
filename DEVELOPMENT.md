...
```bash
git remote add encore encore://simple-backend-5z3i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/simple-backend-5z3i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/simple-backend-5z3i/settings/integrations/github)
